...
sqldb = MySQLdb.connect("localhost","root","harden1313","test" )
...
class TwitterStream:
	...
	global gender
		...
		if message['coordinates'] != 'null':
            ...
            cursor.execute("INSERT INTO TWEETS(USER_ID, NAME, SCREENNAME) VALUES (%s, %s, %s)", (message['user']['id'].encode('utf-8'), fullname.encode('utf-8'), message['user']['screen_name'].encode('utf-8')))
            sqldb.commit()
            sqldb.close()            
            print '*chirp*'
